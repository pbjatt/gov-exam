                    ...
                    <div class="body">
                        ...
                        <div class="formCard">
                            <div class="wrapper">
                                ...
                                @if($guardData->role_id == '1')
                                {{ Form::open(['url' => route('admin.product.update',$product->id), 'method'=>'PUT','files' => true, 'class' => 'user']) }}
                                @endif
                                @if($guardData->role_id == '2')
                                {{ Form::open(['url' => route('shop.product.update',$product->id), 'method'=>'PUT','files' => true, 'class' => 'user']) }}
                                @endif
                                @include('backend.inc.product._form1')
