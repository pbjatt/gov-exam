                        ...
                        <div class="table-responsive">
                            <table class="table table-hover js-basic-example contact_list" id="currentaffair">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="handleDate({{ $list->id }})" style="color: black;">{{ $list->day}}/{{$list->month}}/{{$list->year }}<i class="material-icons" style="font-size: 16px; margin-left: 7px;">mode_edit</i></a>
                                        </td>
                            ...
                            <div class="modal fade" id="dateModal" tabindex="-1" aria-labelledby="dateModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-sm">
                                    <form class="" action="" method="GET" id="dateFormModal" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="formCard">
                                                <div class="wrapper">
                                                    <div class="row mt-4">
                                                        {{Form::date('date', now(), ['class' => 'squareInput mx-4'])}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
...
<script>
    ...
    function handleDate(id) {
        var form = document.getElementById('dateFormModal')
        form.action = 'admin/currentaffair/date/' + id 
