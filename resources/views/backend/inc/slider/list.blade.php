        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="pt-2"><b>Slider List</b></h2>
                            <h2 class="header-dropdown m-r--5"><a href="{{ route('admin.slider.create') }}" class="btn btn-primary" style="padding-top: 8px;">Add Slider</a></h2>
                        </div>
                        <div class="body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-img" style="width: 10%;">
                                                <img src="{{ url('/').'/images/slider/'. $list->image }}" alt="">
                                            </td>
                                            <td>
