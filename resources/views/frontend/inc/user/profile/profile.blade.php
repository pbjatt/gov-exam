                    ...
                    <div class="m-b-20">
                        <div class="contact-grid">
                            <div class="profile-header bg-dark">
                                <div class="user-name" style="padding-top: 25px;">{{ $guardData->name }}</div>
                                <div class="name-center">{{ $guardData->role->name }}</div>
                            </div>
                            ...
                            <div>
                                <span class="phone">
                                    <i class="material-icons">email</i>{{ $guardData->email }}</span>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <h5>564</h5>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <input type="name" name="name" class="form-control" value="{{$guardData->name}}" placeholder="Username">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" value="{{$guardData->email}}" placeholder="Email">
                                </div>
                                <div class="form-group">
