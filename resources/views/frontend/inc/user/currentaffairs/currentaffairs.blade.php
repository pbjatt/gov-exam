                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="breadcrumb breadcrumb-style ">
                        ...
                        <li class="breadcrumb-item bcrumb-2">
                            <a href="{{ route('user.currentaffair.index') }}">Current Affair</a>
                        </li>
                ...
                <div class="card">
                    <div class="body">
                        <div class="header">
                            ...
                            <h2 class="header-dropdown m-r--5" style="top:10px;"><a href="{{ route('user.currentaffair.index') }}" class="btn btn-primary" style="padding-top: 8px;">View Current Affair</a></h2>
                        </div>
                        <hr>
                        <div class="formCard">
                            <div class="wrapper">
                                @if(isset($currentaffair))
                                {{ Form::open(['url' => route('user.currentaffair.update', $currentaffair->id), 'method'=>'PUT', 'files' => true, 'class' => 'user']) }}
                                @else
                                {{ Form::open(['url' => route('user.currentaffair.store'), 'method'=>'POST', 'files' => true, 'class' => 'user']) }}
                                @endif
                                @if(count($errors->all()))
